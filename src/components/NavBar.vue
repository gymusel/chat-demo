<template>
  <div class="h-screen flex flex-col last:justify-end">
            ...
            <div class="flex flex-col p-6 modal">
              ...
              <input
                ...
                class="
                  ...
                  w-full
                  rounded
                  border-gray-900 border-solid border
                  p-3
                "
              />
              ...
              <button
                @click="addChannel"
                class="mt-3 px-8 py-2 rounded bg-green-900 font-bold text-white"
              >
                作成
              </button>
            </div>
    ...
    >
      ...
      <font-awesome-icon
        :icon="['fas', 'ellipsis-h']"
        class="opacity-25 ml-auto mr-2"
      />
    </button>
    <div
      v-show="editProfileModal"
