    ...
    <div class="z-10 bg-gray-800 flex-grow flex items-center justify-center">
      <div class="w-full flex justify-center">
        <div class="w-5/6">
          ...
          <form @submit.prevent="signIn" class="mt-4 flex flex-col items-center">
            <div class="w-full my-2 flex items-center">
              ...
              <input type="email" v-model="email" ref="input" placeholder="email" class="bg-gray-800 w-full text-xl p-3 rounded focus:outline-none focus:bg-gray-700" />
            </div>
            <div class="w-full my-2 flex items-center">
          ...
          <router-link to="/register" class="my-6 w-full h-12 bg-darkgreen rounded-lg flex items-center justify-center focus:outline-none">
